...
const Slider = () => {
    ...
    const interval = setInterval(() => {
      if (sliderRef.current) {
        ...
        if (scrollLeft + clientWidth >= scrollWidth) {
          // If we reach the end, reset the scroll position to the start
  ...
  return (
    <>
      <div
        ref={sliderRef}
        className="w-full relative bottom-28 sm:bottom-0 h-20 bg-gray-200 overflow-x-auto scrollbar-hide"
        style={{
          overflowX: 'auto',
          scrollbarWidth: 'none',
