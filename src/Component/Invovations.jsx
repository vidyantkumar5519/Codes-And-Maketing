...
import img2 from "../assets/adani.png";
import img3 from "../assets/image 88.png";

const Invovations = () => {
  return (
    <>
      <div className="relative bottom-20 md:bottom-0 md:mt-10 flex flex-col lg:flex-row justify-center lg:justify-between h-auto lg:h-[45rem]">
        ...
        <div className="bg-bodycolorGrey w-full lg:w-1/2 h-[26rem] lg:h-auto ">
          ...
          />
          <img
            className="relative right-0 bottom-[20rem] md:bottom-[31rem] h-[20rem] w-auto md:h-[30rem] mx-auto lg:right-44 lg:bottom-[31rem]"
            src={img3}
            alt="img"
          />
        </div>
